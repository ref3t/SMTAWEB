...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $ret = mysql_query("update course set courseCode='$coursecode',courseName='$coursename' where id='$id'");
        if ($ret) {
...
<p>
								...
								<div class="form-group">
									<label for="coursename">Course Name </label> <input type="text"
										...
										value="<?php echo htmlentities($row['courseName']);?>"
										required />
								</div>

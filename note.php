...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        mysql_query("delete from Note where note_id = '" . $_GET['id'] . "'");
        
        $_SESSION['delmsg'] = "Student Note deleted !!";
    }
	...
	<div class="content-wrapper">
		...
		<div class="content-wrapper">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Managed Notes</h1>
					</div>
				</div>
				<div class="row">
							...
							<div class="panel-body">
								<div class="table-responsive table-bordered">
									<table class="table">
										...
										<tbody>
<?php
    $sql = mysql_query("select * from Note");
    $cnt = 1;
    while ($row = mysql_fetch_array($sql)) {
        ?>
                                        ...
                                        <tr>
												...
												<td> <a
													href="note.php?id=<?php echo $row['note_id']?>&del=delete"

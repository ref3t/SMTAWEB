...
$ret=mysql_query("INSERT INTO course (courseCode,courseName) VALUES('$coursecode','$coursename')");
if($ret)
{
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="send_message.php?id=<?php echo $row['id']?>">
<button class="btn btn-primary"><i class="fa fa-edit "></i> Send Message</button> </a> </td>
                                            <td>
